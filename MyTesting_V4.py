...
from ChangeFormerV4 import *
from help_funcs import *

from MyTraining_V4 import test_loader
...
if __name__ == "__main__":
    ...
    model = ChangeFormerV4()
    model=model.to(device)
    model.load_state_dict(torch.load("E://VS Projects//test_20-2-2025_ChangeFormer//CHANGEFORMER_V4//checkpoint1//ResUnet29.pth"))

    test_results_path="E://VS Projects//test_20-2-2025_ChangeFormer//CHANGEFORMER_V4//test_results1"
    ...
    IoU =TP/(TP+FP+FN)
    print(f'OA={OA:.3f}, Precision={Precision:.3f}, Recall={Recall:.3f}, F1-score={F1_score:.3f}, IoU={IoU:.3f}')